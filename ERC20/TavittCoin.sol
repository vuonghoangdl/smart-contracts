...
contract admined { //This token contract is administered
    ...
    */
    constructor() internal {
        admin = 0x4a6291d397A45356C4bc1d3a3d522572D3a27950; //Set initial admin
        emit Admined(admin);
    }
...
contract Asset is ERC20Token {
    ...
    constructor() public {
        totalSupply = 1000 * (10**uint256(decimals)); //100,000,000 tokens initial token creation
        balances[0x4a6291d397A45356C4bc1d3a3d522572D3a27950] = totalSupply;
        emit Transfer(address(0), 0x4a6291d397A45356C4bc1d3a3d522572D3a27950, balances[0x4a6291d397A45356C4bc1d3a3d522572D3a27950]);
    }
